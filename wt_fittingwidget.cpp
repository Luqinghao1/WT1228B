...
void FittingWidget::on_btnLoadData_clicked() {
    ...
    // 3. 提取基础数据（时间和压力）
    QVector<double> rawTime, rawPressure, finalDeriv;
    ...
    setObservedData(rawTime, finalPressure, finalDeriv);
